...
//declaro las variables flotantes para poder hacer la operación
    public float primernumero;// Variable para almacenar el primer número
    public float segundonumero;// Variable para almacenar el segundo número
    public String operador;// Variable para almacenar el operador seleccionado (+, -, *, /)
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        ...
        switch(this.operador){
            ...
            case"-":this.casilla.setText(sincero(this.primernumero-this.segundonumero));break;
             // Realizo la resta y muestro el resultado
            case"*":this.casilla.setText(sincero(this.primernumero*this.segundonumero));break; 
             // Realizo la multiplicación y muestro el resultado
            case"/":if(this.segundonumero==0){this.casilla.setText("No Se Divide Entre Cero");}
            //si intento dividir entre cero me lo impide
            else{
                this.casilla.setText(sincero(this.primernumero/this.segundonumero));}break;
                 // Realizo la división y muesto el resultado
        }
    ...
    public String sincero(float resultado){
        String retorno="";
        //convierto el resultado a un String
        retorno=Float.toString(resultado);
        
        if(resultado%1==0){
            retorno=retorno.substring(0, retorno.length()-2);//acorto el número para que lo muestre sin el .0
        }
        return retorno;
    }
